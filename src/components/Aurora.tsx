...
const COLOR_COMBINATIONS: [string, string, string][] = [
  ["#FF6B6B", "#4ECDC4", "#45B7D1"],  
  ["#A8E6CF", "#DCEDC1", "#FFD3B6"],  
  ["#FF61D2", "#FE90AF", "#FF9190"],  
  ["#2D00F7", "#6A00F4", "#8900F2"], 
  ["#4831D4", "#CCF381", "#3D155F"],  
  ["#00B8A9", "#F8F3D4", "#F6416C"], 
  ["#FFBE0B", "#FB5607", "#FF006E"],  
  ["#8338EC", "#3A86FF", "#5390D9"],  
  ["#06D6A0", "#1B9AAA", "#EF476F"],  
  ["#FF9F1C", "#FFD93D", "#FF4D6D"],  
];
...
export default function Aurora(props: AuroraProps) {
  ...
  const colorStops = COLOR_COMBINATIONS[randomIndex];

  const propsRef = useRef<AuroraProps>({ ...props, colorStops });
